...
describe('Component: ContactList', () => {
	...
	beforeEach(() => {
		TestBed.configureTestingModule({
			imports: [FormsModule],
			declarations: [ContactListComponent, ContactNamePipe],
			providers: [{ provide: ContactService, useClass: ContactServiceMock }]
		});
		contactList = TestBed.createComponent(ContactListComponent).componentInstance;
	});

	it('should retrieve contacts during initialization', inject(
		[ContactService],
